...
type CompressedCacheItem struct {
	Module      string    `dynamodbav:"module"`
...
func (p *Handler) Store(ctx context.Context, key string, versions []modules.Version) error {
	...
	slog.Info("Storing module versions", "key", key, "versions", len(versions))
	...
	slog.Info("Successfully stored module versions", "key", key, "versions", len(versions))
	return nil
}
